...
1. Add All AccountHolders Details into a table(TableName: ActbCustomers)
2. Create Page, where search Customers Info based TypeofBroadband (Pre/Post)
3. Use Servlets and Html Pages.
